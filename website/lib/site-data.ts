...
export const reports: Report[] = [
  ...
  },
  {
    ...
    title: "跨本体预训练、接触闭环与在线适应",
    summary:
      "本期收录十四篇论文，覆盖多本体 VLA、灵巧预训练、触觉 Sim2Real、动态操作、机器人记忆、过程奖励、在线 RL 与人形足底感知。",
    overview:
      "8 月 14–16 日的新工作主要研究异构数据如何转成可执行策略、视觉之外的接触与历史怎样进入闭环，以及真实部署中的扰动恢复、探索效率和安全边界。",
